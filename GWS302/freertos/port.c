...
//	extern uint32_t __MEMORY_B1_segment_start__[];
//	extern uint32_t __MEMORY_B1_segment_end__[];
...
// put our SRAM in with the peripherals
//		*portMPU_REGION_ATTRIBUTE =		( portMPU_REGION_READ_WRITE | portMPU_REGION_EXECUTE_NEVER ) |
//										( prvGetMPURegionSizeSetting( (uint32_t) __MEMORY_B1_segment_end__ - portPERIPHERALS_START_ADDRESS ) ) |
//										( portMPU_REGION_ENABLE );
